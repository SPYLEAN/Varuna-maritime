# PowerShell Developer Startup Script for SAMUDRANETRA
...
Write-Host "SAMUDRANETRA — DEVELOPER WORKSTATION STARTUP" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
...
Write-Host "`nSAMUDRANETRA is running!" -ForegroundColor Yellow
